...
describe("StringSearchableCollection class tests", () => {
    const string_searchable_collection: StringSearchableCollection = new StringSearchableCollection([]);

    it("StringSearchableCollection constructor", () => {
        expect(string_searchable_collection).to.be.instanceof(StringSearchableCollection);
    ...
    it("Function addItem", () => {
        ...
        expect(string_searchable_collection.collection).to.be.eql(["hola", "queso", "tarta", "que", "abierto"]);
    });
    ...
    it("Function search", () => {
        expect(string_searchable_collection.search("hola")).to.be.eql(["hola", "hola"]);
